...
import { CREATE_PFAV } from '../../pages/Graphql/Mutations';
...
const ResvForm = (props) =>{
    ...
    const [cre_ps] = useMutation(CREATE_USER);
    const [cr_fav] = useMutation(CREATE_PFAV)
    ...
    function poneloFavorito(){
        cr_fav({
            variables:{
                id_favorito:null,
                puesto: props.tableId,
                id_user_fk:5,  
            },
        })
                ...
                <div className={styles.bg_container} ref={focusDiv} tabIndex={0} onKeyUp={(event) => handleKeyEvent(event)}>
                    <div className={styles.form_container}>
                        ...
                        <label className={styles.form_title}>Mesa {props.tableId} {props.building_city} {props.building_floor} 
                            ...
                            : 
                            <AiOutlineStar className={styles.fav_icon} onClick={() => {setFavourite(true);poneloFavorito()}} />}
                        </label>
